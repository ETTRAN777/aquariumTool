import{h as e,n as t,p as n,r,s as i,t as a,v as o}from"./index-BYNcrAlY.js";var s=o(e(),1),c=`# Tank Tracker — AI Quickstart & Import Guide
...
\`\`\`
`,l=i();function u(){let[e,r]=(0,s.useState)(`ai`),[i,a]=(0,s.useState)(!1),[o,u]=(0,s.useState)(null);async function p(){try{await navigator.clipboard.writeText(c),a(!0),setTimeout(()=>a(!1),2e3)}catch{u(`Could not copy automatically — select the text below and copy manually.`)}}return(0,l.jsxs)(`div`,{className:`min-h-screen bg-deepwater text-foam font-body`,children:[(0,l.jsxs)(`header`,{className:`border-b border-moss/30 px-6 md:px-10 py-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4`,children:[(0,l.jsxs)(`div`,{children:[(0,l.jsx)(n,{to:`/`,className:`text-xs text-foam-dim hover:text-amber font-mono`,children:`← Back`}),(0,l.jsx)(`h1`,{className:`font-display text-3xl md:text-4xl font-semibold mt-1`,children:e===`ai`?`AI Quickstart & Import Guide`:`Features Guide`})]}),e===`ai`&&(0,l.jsx)(`button`,{onClick:p,className:`btn btn-primary self-start`,children:i?`✓ Copied`:`Copy full documentation`})]}),(0,l.jsxs)(`div`,{className:`px-6 md:px-10 pt-6 flex gap-2`,children:[(0,l.jsx)(d,{active:e===`ai`,onClick:()=>r(`ai`),label:`AI Quickstart`}),(0,l.jsx)(d,{active:e===`features`,onClick:()=>r(`features`),label:`Features Guide`})]}),(0,l.jsx)(`main`,{className:`px-6 md:px-10 py-8 max-w-4xl mx-auto space-y-6`,children:e===`ai`?(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(`div`,{className:`card p-5`,children:(0,l.jsxs)(`p`,{className:`text-sm text-foam-dim leading-relaxed`,children:[`This page is written for an AI assistant, and gives it real context on this whole site — not just how to generate an import file. Copy the whole thing above and paste it into a chat with an AI, along with your own aquarium build plan (in whatever level of detail you have). It can talk through what the app actually does, help you think through a plan, and — once you're ready — generate a file you bring in from the`,` `,(0,l.jsx)(`span`,{className:`text-foam`,children:`New Tank`}),` screen's`,` `,(0,l.jsx)(`span`,{className:`text-foam`,children:`"Import a tank from a backup file"`}),` section — works even as a brand-new user with no existing tanks.`]})}),(0,l.jsx)(`div`,{className:`card p-5`,children:(0,l.jsx)(`pre`,{className:`whitespace-pre-wrap font-mono text-xs leading-relaxed text-foam-dim overflow-x-auto`,children:c})})]}):(0,l.jsx)(f,{})}),(0,l.jsx)(t,{message:o,onDismiss:()=>u(null)})]})}function d({active:e,onClick:t,label:n}){return(0,l.jsx)(`button`,{onClick:t,className:`pill py-1.5 px-3 text-xs shrink-0 whitespace-nowrap ${e?`bg-moss text-foam`:`bg-deepwater text-foam-dim hover:text-foam border border-moss/30`}`,children:n})}function f(){return(0,l.jsxs)(`div`,{className:`space-y-4`,children:[(0,l.jsx)(`p`,{className:`text-sm text-foam-dim leading-relaxed`,children:`A few real features live on specific pages and are easy to miss unless you happen to land there. Collected here in one place.`}),(0,l.jsx)(p,{icon:`🖼`,title:`Concept image prompt`,location:`Dashboard`,to:`/`,children:`Assembles this tank's real roster (hardscape, substrate, plants, livestock), style, and dimensions into a ready-to-paste prompt for whatever AI image tool you already use — a way to visualize a build before buying anything. The app never calls an image API itself, only assembles the prompt from real data.`}),(0,l.jsx)(p,{icon:`📋`,title:`Research prompt`,location:`Compatibility`,to:`/targets`,children:`Hands the actual research step to whatever AI you use, for the tank overall or for a single roster item — asks explicitly for real, sourced water-parameter ranges rather than a fabricated single number, and for an averaged, clearly-marked estimate wherever a source is likely to report a range instead of one figure.`}),(0,l.jsx)(p,{icon:`📈`,title:`Progress check prompt`,location:`Timeline`,to:`/timeline`,children:`Assembles this tank's real logged history — phase durations, the major-milestone list, and actual entry content grounded to whatever produced a milestone — into a prompt for an honest progress check from an AI, not just a recap of the original plan.`}),(0,l.jsx)(p,{icon:`📋`,title:`Startpage widget`,location:`Settings`,to:`/settings`,children:`Embeds this tank's name, age, most relevant schedule task, and last log entry on another page you control, live and refreshed on load. Chrome is the browser this is expected to work in reliably; Safari has real, accepted limitations around the storage access this needs.`})]})}function p({icon:e,title:t,location:r,to:i,children:a}){return(0,l.jsxs)(`div`,{className:`card p-5`,children:[(0,l.jsxs)(`div`,{className:`flex items-center justify-between gap-3 mb-2`,children:[(0,l.jsxs)(`p`,{className:`font-display text-lg font-semibold`,children:[e,` `,t]}),(0,l.jsxs)(n,{to:i,className:`text-xs font-mono text-sand hover:text-amber whitespace-nowrap`,children:[r,` →`]})]}),(0,l.jsx)(`p`,{className:`text-sm text-foam-dim leading-relaxed`,children:a})]})}export{u as default};